...
class SC_Calculator():
    ...
    def n_floor(self):
        try:
            self.result = False
            self.current = math.floor(float(ent_field.get()))
            self.Entry(self.current)
        except ValueError:
            self.Entry('Error')
        except SyntaxError:
    ...
    def n_ceil(self):
        try:
            self.result = False
            self.current = math.ceil(float(ent_field.get()))
            self.Entry(self.current)
        except ValueError:
            self.Entry('Error')
        except SyntaxError:
...
btn_x_pow = tk.Button(root, text='pow', command=lambda: sc_app.Standard_Ops('**'),
                       font=FONT, width=5, height=2, fg="#000000",
                       highlightbackground='#ADD8E6', highlightthickness=2)
btn_x_pow.grid(row=2, column=7, sticky='n'+'s'+'e'+'w', padx=3, pady=3)

btn_x_floor= tk.Button(root, text='floor', command=lambda: sc_app.n_floor(),
                         font=FONT, width=5, height=2, fg="#000000",
                         highlightbackground='#ADD8E6', highlightthickness=2)
btn_x_floor.grid(row=3, column=7, sticky='n'+'s'+'e'+'w', padx=3, pady=3)

btn_x_ceil = tk.Button(root, text='ceil', command=lambda: sc_app.n_ceil(),
                          font=FONT, width=5, height=2, fg="#000000",
                          highlightbackground='#ADD8E6', highlightthickness=2)
btn_x_ceil.grid(row=4, column=7, sticky='n'+'s'+'e'+'w', padx=3, pady=3)
